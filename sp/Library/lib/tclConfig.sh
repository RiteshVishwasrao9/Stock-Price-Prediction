...
# installed.
TCL_PREFIX='D:/Ritesh/Projects/Stock Market Prediction/sp\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Ritesh/Projects/Stock Market Prediction/sp\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Ritesh/Projects/Stock Market Prediction/sp\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Ritesh/Projects/Stock Market Prediction/sp\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Ritesh/Projects/Stock Market Prediction/sp\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Ritesh/Projects/Stock Market Prediction/sp\Library\lib\tclstub86.lib'
